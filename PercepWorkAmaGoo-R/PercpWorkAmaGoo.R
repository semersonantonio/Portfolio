...
# -------------------------------------
# Data loading
df_amazon <- read_csv("Data/amazon.csv")
df_google <- read_csv("Data/google.csv")
...
# Convert text vectors into volatile corpora
...
# Feature extraction and analysis of positive reviews
...
# Create positive comments dataframe
...
# Feature extraction and analysis of negative reviews
...
# Create negative comments dataframe
...
# Main phrases appearing in the word clouds
amazon_p_tdm    <- TermDocumentMatrix(amazon_pros_corp, control = list(tokenize = tokenizer))
...
# -------------------------------------
# Comparative word cloud for Google positive and negative reviews,
# for comparison with Amazon.
...
# Pyramid plot aligning positive comments
...
# -------------------------------------
# Negative reviews using the same visual resources.
...
# Most frequent words in employee comments
